    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_verified', models.IntegerField(db_index=True, default=0)),
                ('allow_order', models.BooleanField(default=False)),
                ('photo_id', models.CharField(blank=True, max_length=256)),
                ('card', models.CharField(blank=True, max_length=256)),
                ...
                ('gender', models.IntegerField(db_index=True, default=0)),
                ('domestic', models.IntegerField(db_index=True, default=0)),
                ('telecom', models.CharField(blank=True, max_length=16)),
