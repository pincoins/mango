# Generated by Django 4.2.6 on 2023-11-04 03:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(default='BANK_TRANSFER', max_length=32)),
                ('transaction_id', models.CharField(blank=True, max_length=64, null=True)),
                ('status', models.CharField(default='ORDERED', max_length=32)),
                ('payment', models.CharField(default='UNPAID', max_length=32)),
                ('delivery', models.CharField(default='NOT_SENT', max_length=32)),
                ('visible', models.CharField(default='VISIBLE', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.CharField(default='IN_STOCK', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default='PURCHASED', max_length=32)),
